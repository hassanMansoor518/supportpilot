...
export default function DashboardLeftSide() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 transform md:relative md:translate-x-0 transition-transform duration-300 w-[280px] h-screen bg-white border-r border-gray-100 flex flex-col font-sans ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {/* Header / Logo */}
