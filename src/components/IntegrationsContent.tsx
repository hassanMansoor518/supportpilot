        ...
        <div className="rounded-[28px] border border-slate-200/80 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)]">
          <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-[17px] font-semibold text-slate-900">Your Embed Code</h2>
                <p className="text-sm text-slate-500">Copy and paste this snippet before the closing body tag.</p>
              </div>
            </div>
            <button
              onClick={handleCopy}
            ...
            <pre className="overflow-x-auto p-5 text-[13px] leading-7 font-mono text-slate-300">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <br />
                  <span className="ml-4 text-blue-300">data-owner-id</span>
                  <span className="text-slate-500">=</span>
                  <span className="text-emerald-400">"{ownerId}"</span>
